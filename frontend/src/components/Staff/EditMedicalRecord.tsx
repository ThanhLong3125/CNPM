          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div>
              <div className="mb-4">
                ...
                <input type="date" defaultValue="16/04/2025 - 15:30" className="w-full px-3 py-1.5 bg-[#f0f0f0] rounded" />
              </div>
              ...
              <div className="flex justify-end gap-4 mt-6">
                <button className="bg-[#4977b8] hover:bg-blue-700 text-white px-10 py-2 rounded">Ưu tiên</button>
                <button className="border border-gray-500 hover:bg-blue-400 text-black-900 px-10 py-2 rounded">Hủy</button>
                <button className="bg-[#4977b8] hover:bg-blue-700 text-white px-10 py-2 rounded">Xác nhận</button>
              </div>
            </div>
          </div>
        </div>
